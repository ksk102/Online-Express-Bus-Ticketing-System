						...
						<div id="viewannouncement-table">
							<table width="770px">
								...
								while($row=mysqli_fetch_assoc($sql_announcement))
								{
									?>
									<tr>
										<td><?php echo "<a href=\"user_view_announcement_detail.php?ann_id={$row['ANN_ID']}\">{$row['ANN_ID']}</a>";?></td>
							...
							<div id="page-selection">
								<?php
										...
										<?php
										//Going to first page
										echo "<li style='width:80px;'><a href='user_view_announcement.php?page=1'>".'First Page'."</a></li> ";

										for ($i=1; $i<=$total_pages; $i++) {

										echo "<li><a href='user_view_announcement.php?page=".$i."'>".$i."</a></li> ";
										};
										// Going to last page
										echo "<li style='width:80px;'><a href='user_view_announcement.php?page=$total_pages'>".'Last Page'."</a></li> ";
										?>
										</ul>
							</div>
						</div>
